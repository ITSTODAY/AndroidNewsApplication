...
//       return password;   //解码一下
    ...
    private void initViews() {
        ...
        myRegistBtn = (Button) findViewById(R.id.btn_signup);
    }
        ...
        Thread loginRunnable = new Thread() {
            ...
            public void run() {
                ...
                if(state==0){
                    ...
                    intent.putExtra("ID",checkUser.getuserId());
                    intent.putExtra("result",userId);
                    LoginActivity.this.setResult(1998,intent);
                    finish();
                }
    ...
    public void showLoading() {
        if (mLoadingDialog == null) {
            mLoadingDialog = new LoadingDialog(this, "正在登录中，请稍后", false);
        }
        mLoadingDialog.show();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try{
            ...
            if(result=="1") {
                et_name.setText(data.getExtras().getString("userID"));
                et_password.setText(data.getExtras().getString("password"));
            }
        }catch (Exception e){}
    }
}
